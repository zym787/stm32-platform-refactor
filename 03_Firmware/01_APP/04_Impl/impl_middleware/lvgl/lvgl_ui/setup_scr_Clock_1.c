...
void setup_scr_Clock_1(lv_ui *ui)
{
    ...
    lv_img_set_src(ui->Clock_1_img_1, &_sheshidu_alpha_10x10_ext);
    ...
    lv_img_set_src(ui->Clock_1_img_2, &_wather16x16_alpha_16x16_ext);
    ...
    lv_img_set_src(ui->Clock_1_img_3, &_heart16x16_alpha_16x16_ext);
    ...
    lv_img_set_src(ui->Clock_1_img_4, &_KLL16x16_alpha_16x16_ext);
    ...
    lv_img_set_src(ui->Clock_1_img_5, &_foot16x16_alpha_16x16_ext);
    ...
    lv_obj_set_style_text_font(ui->Clock_1_label_6, &lv_font_interttf_82, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->Clock_1_label_7, &lv_font_interttf_82, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    //Write codes Clock_1_cont_1
    ui->Clock_1_cont_1 = lv_obj_create(ui->Clock_1);
    lv_obj_set_pos(ui->Clock_1_cont_1, -140, 0);
    lv_obj_set_size(ui->Clock_1_cont_1, 120, 280);
    lv_obj_set_scrollbar_mode(ui->Clock_1_cont_1, LV_SCROLLBAR_MODE_OFF);

    //Write style for Clock_1_cont_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->Clock_1_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->Clock_1_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->Clock_1_cont_1, 180, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->Clock_1_cont_1, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->Clock_1_cont_1, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->Clock_1_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->Clock_1_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->Clock_1_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->Clock_1_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->Clock_1_cont_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes Clock_1_btn_1
    ui->Clock_1_btn_1 = lv_btn_create(ui->Clock_1_cont_1);
    ui->Clock_1_btn_1_label = lv_label_create(ui->Clock_1_btn_1);
    lv_label_set_text(ui->Clock_1_btn_1_label, "");
    lv_label_set_long_mode(ui->Clock_1_btn_1_label, LV_LABEL_LONG_WRAP);
    lv_obj_align(ui->Clock_1_btn_1_label, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_style_pad_all(ui->Clock_1_btn_1, 0, LV_STATE_DEFAULT);
    lv_obj_set_width(ui->Clock_1_btn_1_label, LV_PCT(100));
    lv_obj_set_pos(ui->Clock_1_btn_1, 5, 158);
    lv_obj_set_size(ui->Clock_1_btn_1, 110, 50);

    //Write style for Clock_1_btn_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->Clock_1_btn_1, 204, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->Clock_1_btn_1, lv_color_hex(0x535353), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->Clock_1_btn_1, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->Clock_1_btn_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->Clock_1_btn_1, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->Clock_1_btn_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->Clock_1_btn_1, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->Clock_1_btn_1, &lv_font_alimama_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->Clock_1_btn_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->Clock_1_btn_1, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes Clock_1_btn_2
    ui->Clock_1_btn_2 = lv_btn_create(ui->Clock_1_cont_1);
    ui->Clock_1_btn_2_label = lv_label_create(ui->Clock_1_btn_2);
    lv_label_set_text(ui->Clock_1_btn_2_label, "");
    lv_label_set_long_mode(ui->Clock_1_btn_2_label, LV_LABEL_LONG_WRAP);
    lv_obj_align(ui->Clock_1_btn_2_label, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_style_pad_all(ui->Clock_1_btn_2, 0, LV_STATE_DEFAULT);
    lv_obj_set_width(ui->Clock_1_btn_2_label, LV_PCT(100));
    lv_obj_set_pos(ui->Clock_1_btn_2, 5, 215);
    lv_obj_set_size(ui->Clock_1_btn_2, 50, 50);

    //Write style for Clock_1_btn_2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->Clock_1_btn_2, 204, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->Clock_1_btn_2, lv_color_hex(0x5a5a5a), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->Clock_1_btn_2, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->Clock_1_btn_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->Clock_1_btn_2, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->Clock_1_btn_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->Clock_1_btn_2, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->Clock_1_btn_2, &lv_font_alimama_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->Clock_1_btn_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->Clock_1_btn_2, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes Clock_1_btn_3
    ui->Clock_1_btn_3 = lv_btn_create(ui->Clock_1_cont_1);
    ui->Clock_1_btn_3_label = lv_label_create(ui->Clock_1_btn_3);
    lv_label_set_text(ui->Clock_1_btn_3_label, "");
    lv_label_set_long_mode(ui->Clock_1_btn_3_label, LV_LABEL_LONG_WRAP);
    lv_obj_align(ui->Clock_1_btn_3_label, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_style_pad_all(ui->Clock_1_btn_3, 0, LV_STATE_DEFAULT);
    lv_obj_set_width(ui->Clock_1_btn_3_label, LV_PCT(100));
    lv_obj_set_pos(ui->Clock_1_btn_3, 65, 216);
    lv_obj_set_size(ui->Clock_1_btn_3, 50, 50);

    //Write style for Clock_1_btn_3, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->Clock_1_btn_3, 204, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->Clock_1_btn_3, lv_color_hex(0x5a5a5a), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->Clock_1_btn_3, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->Clock_1_btn_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->Clock_1_btn_3, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->Clock_1_btn_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->Clock_1_btn_3, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->Clock_1_btn_3, &lv_font_alimama_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->Clock_1_btn_3, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->Clock_1_btn_3, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes Clock_1_img_6
    ui->Clock_1_img_6 = lv_img_create(ui->Clock_1_cont_1);
    lv_obj_add_flag(ui->Clock_1_img_6, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->Clock_1_img_6, &_BT32_alpha_32x32_ext);
    lv_img_set_pivot(ui->Clock_1_img_6, 50,50);
    lv_img_set_angle(ui->Clock_1_img_6, 0);
    lv_obj_set_pos(ui->Clock_1_img_6, 42, 166);
    lv_obj_set_size(ui->Clock_1_img_6, 32, 32);

    //Write style for Clock_1_img_6, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_img_recolor_opa(ui->Clock_1_img_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->Clock_1_img_6, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->Clock_1_img_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->Clock_1_img_6, true, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes Clock_1_img_7
    ui->Clock_1_img_7 = lv_img_create(ui->Clock_1_cont_1);
    lv_obj_add_flag(ui->Clock_1_img_7, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->Clock_1_img_7, &_mianti_0_alpha_32x32_ext);
    lv_img_set_pivot(ui->Clock_1_img_7, 50,50);
    lv_img_set_angle(ui->Clock_1_img_7, 0);
    lv_obj_set_pos(ui->Clock_1_img_7, 13, 224);
    lv_obj_set_size(ui->Clock_1_img_7, 32, 32);

    //Write style for Clock_1_img_7, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_img_recolor_opa(ui->Clock_1_img_7, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->Clock_1_img_7, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->Clock_1_img_7, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->Clock_1_img_7, true, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes Clock_1_label_11
    ui->Clock_1_label_11 = lv_label_create(ui->Clock_1_cont_1);
    lv_label_set_text(ui->Clock_1_label_11, "24~28");
    lv_label_set_long_mode(ui->Clock_1_label_11, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->Clock_1_label_11, 53, 45);
    lv_obj_set_size(ui->Clock_1_label_11, 58, 19);

    //Write style for Clock_1_label_11, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->Clock_1_label_11, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->Clock_1_label_11, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->Clock_1_label_11, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->Clock_1_label_11, &lv_font_alimama_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->Clock_1_label_11, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->Clock_1_label_11, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->Clock_1_label_11, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->Clock_1_label_11, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->Clock_1_label_11, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->Clock_1_label_11, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->Clock_1_label_11, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->Clock_1_label_11, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->Clock_1_label_11, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->Clock_1_label_11, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes Clock_1_img_8
    ui->Clock_1_img_8 = lv_img_create(ui->Clock_1_cont_1);
    lv_obj_add_flag(ui->Clock_1_img_8, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->Clock_1_img_8, &_zhengdong_0_alpha_32x32_ext);
    lv_img_set_pivot(ui->Clock_1_img_8, 50,50);
    lv_img_set_angle(ui->Clock_1_img_8, 0);
    lv_obj_set_pos(ui->Clock_1_img_8, 72, 223);
    lv_obj_set_size(ui->Clock_1_img_8, 32, 32);

    //Write style for Clock_1_img_8, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_img_recolor_opa(ui->Clock_1_img_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->Clock_1_img_8, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->Clock_1_img_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->Clock_1_img_8, true, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes Clock_1_img_9
    ui->Clock_1_img_9 = lv_img_create(ui->Clock_1_cont_1);
    lv_obj_add_flag(ui->Clock_1_img_9, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->Clock_1_img_9, &_copesss_alpha_32x32_ext);
    lv_img_set_pivot(ui->Clock_1_img_9, 50,50);
    lv_img_set_angle(ui->Clock_1_img_9, 0);
    lv_obj_set_pos(ui->Clock_1_img_9, 15, 95);
    lv_obj_set_size(ui->Clock_1_img_9, 32, 32);

    //Write style for Clock_1_img_9, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_img_recolor_opa(ui->Clock_1_img_9, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->Clock_1_img_9, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->Clock_1_img_9, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->Clock_1_img_9, true, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes Clock_1_img_10
    ui->Clock_1_img_10 = lv_img_create(ui->Clock_1_cont_1);
    lv_obj_add_flag(ui->Clock_1_img_10, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->Clock_1_img_10, &_weater32x32_alpha_32x32_ext);
    lv_img_set_pivot(ui->Clock_1_img_10, 50,50);
    lv_img_set_angle(ui->Clock_1_img_10, 0);
    lv_obj_set_pos(ui->Clock_1_img_10, 13, 22);
    lv_obj_set_size(ui->Clock_1_img_10, 32, 32);

    //Write style for Clock_1_img_10, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_img_recolor_opa(ui->Clock_1_img_10, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->Clock_1_img_10, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->Clock_1_img_10, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->Clock_1_img_10, true, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes Clock_1_label_10
    ui->Clock_1_label_10 = lv_label_create(ui->Clock_1_cont_1);
    lv_label_set_text(ui->Clock_1_label_10, "小雨");
    lv_label_set_long_mode(ui->Clock_1_label_10, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->Clock_1_label_10, 60, 23);
    lv_obj_set_size(ui->Clock_1_label_10, 42, 19);

    //Write style for Clock_1_label_10, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->Clock_1_label_10, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->Clock_1_label_10, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->Clock_1_label_10, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->Clock_1_label_10, &lv_font_alimama_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->Clock_1_label_10, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->Clock_1_label_10, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->Clock_1_label_10, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->Clock_1_label_10, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->Clock_1_label_10, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->Clock_1_label_10, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->Clock_1_label_10, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->Clock_1_label_10, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->Clock_1_label_10, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->Clock_1_label_10, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes Clock_1_label_12
    ui->Clock_1_label_12 = lv_label_create(ui->Clock_1_cont_1);
    lv_label_set_text(ui->Clock_1_label_12, "北纬\n27.6\n东经\n48.5");
    lv_label_set_long_mode(ui->Clock_1_label_12, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->Clock_1_label_12, 58, 79);
    lv_obj_set_size(ui->Clock_1_label_12, 48, 65);

    //Write style for Clock_1_label_12, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->Clock_1_label_12, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->Clock_1_label_12, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->Clock_1_label_12, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->Clock_1_label_12, &lv_font_alimama_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->Clock_1_label_12, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->Clock_1_label_12, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->Clock_1_label_12, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->Clock_1_label_12, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->Clock_1_label_12, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->Clock_1_label_12, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->Clock_1_label_12, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->Clock_1_label_12, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->Clock_1_label_12, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->Clock_1_label_12, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes Clock_1_cont_2
    ui->Clock_1_cont_2 = lv_obj_create(ui->Clock_1);
    lv_obj_set_pos(ui->Clock_1_cont_2, 0, 0);
    lv_obj_set_size(ui->Clock_1_cont_2, 240, 280);
    lv_obj_set_scrollbar_mode(ui->Clock_1_cont_2, LV_SCROLLBAR_MODE_OFF);
    lv_obj_add_flag(ui->Clock_1_cont_2, LV_OBJ_FLAG_HIDDEN);

    //Write style for Clock_1_cont_2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->Clock_1_cont_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->Clock_1_cont_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->Clock_1_cont_2, 140, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->Clock_1_cont_2, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->Clock_1_cont_2, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->Clock_1_cont_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->Clock_1_cont_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->Clock_1_cont_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->Clock_1_cont_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->Clock_1_cont_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
