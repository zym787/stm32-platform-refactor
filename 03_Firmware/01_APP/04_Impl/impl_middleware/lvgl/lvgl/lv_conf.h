...
#if LV_TICK_CUSTOM
    #define LV_TICK_CUSTOM_INCLUDE "osal_task.h"         /*Header for the system time function*/
    #define LV_TICK_CUSTOM_SYS_TIME_EXPR ((uint32_t)osal_task_get_tick_count())    /*Expression evaluating to current system time in ms*/
...
#define LV_FONT_MONTSERRAT_14 0   /* UI exclusively uses alimama/interttf — saves ~14 KB Flash */
...
#if LV_USE_LABEL
    #define LV_LABEL_TEXT_SELECTION 0 /*Enable selecting text of the label -- unused on this UI*/
